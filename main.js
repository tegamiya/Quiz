(function(){
    ...
    //クイズの中身
    var quizSet = [
        {q: '紅一点は中国の詩に由来する言葉ですが、紅一点とは何の花をさすでしょうか？' , a: ['ザクロ','バラ','ボタン'] , c: '緑一面の世界に真っ赤なザクロの花が一輪だけ咲いていて目立つことが語源です'},
        {q: '目からうろこの語源はある人物が起こした奇跡です。その人物は誰でしょうか？' , a: ['キリスト','ムハンマド','ブッタ'] ,
        c: 'キリスト教を迫害していたサウロの目が見えなくなった時、イエスに使わされたアナニヤがサウロの目の上に手を置くと、サウロは目が見えるようになりました。 <br><br> この時サウロが、「目から鱗のようなものが落ちた」といったことから。'},
        {q: 'サボるの語源は何語でしょうか？' , a: ['フランス語','ロシア語','ギリシャ語'] , c: 'フランス語で労働争議中の労働者による生産設備等の破壊行動を指します。転じて日本では意図的な怠業を指す言葉となりました。'}
